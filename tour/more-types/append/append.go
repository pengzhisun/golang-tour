/* ****************************************************************************
 * Tour: Appending to a slice
 * Link: https://tour.golang.org/moretypes/15
 * ----------------------------------------------------------------------------
 * It is common to append new elements to a slice, and so Go provides a
 * built-in append function. The documentation of the built-in package
 * describes append.
 ...
 * array will be allocated. The returned slice will point to the newly
 * allocated array.
 *
