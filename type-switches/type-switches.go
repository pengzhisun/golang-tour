/* ****************************************************************************
 * Tour: Type switches
 * Link: https://tour.golang.org/methods/16
 * ----------------------------------------------------------------------------
 ...
 * type T or S. In each of the T and S cases, the variable v will be of type T
 * or S respectively and hold the value held by i. In the default case (where
 * there is no match), the variable v is of the same interface type and value
 * as i.
 * ***************************************************************************/
